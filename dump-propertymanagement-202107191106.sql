...
CREATE TABLE `owner` (
  ...
  `houseproperty_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `owner_phone` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`owner_id`),
  KEY `owner_FK` (`houseproperty_id`),
  CONSTRAINT `owner_FK` FOREIGN KEY (`houseproperty_id`) REFERENCES `house` (`houseproperty_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-07-19 11:06:23

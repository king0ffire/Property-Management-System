...
public class Housefeeinfo {
    ...
    public Housefeeinfo(int block_id, int room_no, Date check_in_date, String unit_type, int area, String owner_name,
                        String cost_reason, Date cost_time, double cost_total, double pay_money, Date pay_time,
                        String pay_remark) {

...
public class Property {
    ...
    public Map<String, Object> total(String owner_id) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT owner_name,count(property_id) FROM owner A inner join house B on A.owner.id = B.owner_id GROUP BY property_id");
    ...
    public List<OH> ownerHouse() {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM owner A inner join house B on A.owner_id = B.owner_id");
